          ...
          {PLANS.map((plan) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ fontSize: "15px", fontWeight: 700, fontFamily: "'Syne',sans-serif", marginBottom: "4px", color: plan.primary ? "var(--accent)" : "var(--text)" }}>
                  {t[pk + "n"]}
                </div>
                ...
                <div style={{ display: "flex", alignItems: "flex-end", gap: "4px", marginBottom: "6px" }}>
                  <span style={{ fontFamily: "'Syne',sans-serif", fontSize: "42px", fontWeight: 800, color: plan.primary ? "var(--accent)" : "var(--text)", lineHeight: 1 }}>
                    ${price}
                  </span>
                ...
                {plan.py && yearly ? (
                  <div style={{ fontSize: "11px", color: "#4FD6A0", marginBottom: "12px", padding: "3px 10px", background: "rgba(79,214,160,0.08)", border: "1px solid rgba(79,214,160,0.2)", borderRadius: "8px", display: "inline-block" }}>
                ...
                <div style={{ marginBottom: "20px" }}>
                  {features.map((f, j) => {
                    ...
                    return (
                      <div key={j} style={{ display: "flex", gap: "8px", alignItems: "flex-start", marginBottom: "8px", fontSize: "13px" }}>
