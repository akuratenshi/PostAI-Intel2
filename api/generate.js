...
ПЛОТНОСТЬ ТЕКСТА — ГЛАВНОЕ ПРАВИЛО:
- Каждое предложение добавляет новую информацию. Если его можно удалить без потери смысла — удали.
- Не повторяй одну мысль разными словами.
- Не заполняй объём ради объёма. Лучше короткий плотный пост, чем длинный пустой.
- Пиши как журналист: факт → контекст → вывод. Без воды.

ЗАПРЕЩЕНО — ФОРМАТИРОВАНИЕ:
- Точки или тире в начале строки (". Текст", "— Текст") — артефакт, ломает читаемость
- Пустые строки между каждым пунктом списка — список идёт компактно, без воздуха
- КАПСЛОК в заголовках — выглядит агрессивно и дёшево
- Символы "—", "---", "___" в самом конце поста
- Лишние пустые строки в конце поста
...
- НЕ начинай с "В современном мире...", "Друзья,", "Сегодня хочу рассказать..."
- Избегай слов: уникальный, инновационный, революционный, эксклюзивный, невероятный`;
